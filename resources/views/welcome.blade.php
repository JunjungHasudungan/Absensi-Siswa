        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-800 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    <x-jet-button class="justify-center font-bold w-full">
                        <h3 class="text-center">
                             <a href="{{ route('login') }}" class="text-sm w-full underline:none">Login</a>
                            </h3>
                    </x-jet-button>
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="{{ route('login') }}" class="underline-none text-gray-900 dark:text-white">
                                        Mata Pelajaran
                                    </a>
                                    </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-gray-500">
                                  ...
                                  <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                                    <a href="{{ route('login') }}" class="underline-none">
                                        Kelas
                                    </a>
                                </div>
                            </div>
